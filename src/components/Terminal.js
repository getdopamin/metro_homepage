...
const Terminal = () => {
	...
	return (
		<div
			className={`absolute w-full h-auto transform -translate-x-1/2 lg:-translate-y-1/2 bg-window-color max-w-full  lg:max-w-terminal p-terminal top-0 bottom-0 lg:bottom-[initial] lg:top-1/2 left-1/2 ${
